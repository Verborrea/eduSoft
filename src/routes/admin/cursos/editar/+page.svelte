...
<div class="main">
	...
	<form method="post" class="fcol24">
		...
		<label for="module">
			Módulo:
			<select id="module" name="module" class="select" required value={data.course.module}>
		...
		<label for="career">
			Carrera:
			<select id="career" class="select" name="career" required value={data.course.career}>
