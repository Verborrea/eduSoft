...
<div class="main">
  ...
  <form action="" class="fcol24">
    <label>
      Nombre:
      <input class="input" type="text" placeholder="Ej. Auditoría y Negocios">
    </label>
    <div class="flex g24 align-end">
      <label class="flex1">
        Semestre:
        <div class="select">
          <select>
      ...
      <label class="flex1">
        Créditos:
        <input class="input" type="text" placeholder="Ej.4">
      </label>
    </div>
    <label>
      Carrera:
      <div class="select">
        <select>
          ...
          <option value=""> {carrera.name} </option>
          {/each}
        </select>
      </div>
    </label>
    <label>
      Descripción:
      <textarea class="input" placeholder="¿Sobre qué trata este curso?" rows=4></textarea>
    </label>
    <div class="flex justify-end g12">
      <button class="btn btn-secondary" on:click={volver}>Cancelar</button>
