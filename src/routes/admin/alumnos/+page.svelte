...
<div class="main">
	...
	<div class="table">
		<table>
			...
			<tr>
				...
				<td> {alumno.dni} </td>
				<td class="cell-fc"> {alumno.expand ? alumno.expand.career.short_name : '-'} </td>
				<td>
	...
	<div class="pagination f-r-c">
		<div class="f-r-c g24">	
			<span>1-10 de X estudiantes</span>
			<span class="qty-sel">x estudiantes seleccionados</span>
		</div>
		<div class="f-r-c g8">
			<button class="btn btn-secondary pag-btn">
				<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
