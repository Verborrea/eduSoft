...
<article id="unit{index}" class="fcol16">
	<h1>Unidad {index}: <span contenteditable>{unit.name}</span></h1>
	<section class="themes fcol16">
		...
		{/each}
		<button type="button" class="btn yellow" on:click={addTheme}>
			+ Añadir Tema
		</button>
